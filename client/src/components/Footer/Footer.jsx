        ...
        <div>
          ...
          >
            <img
              src={logo}
              alt="Logo"
              className="h-8 w-8 object-contain text-blue-850"
            />
            Wealthy<span className="text-blue-900">Bridge</span>
          </Link>
          <p className="mt-4 text-sm text-gray-400">
            Smart investing made simple. Grow your wealth with flexible, secure,
        ...
        <div>
          ...
          <form className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              className="px-4 py-2 rounded-md border text-white text-sm focus:outline-none bg-gray-800"
            />
            <button
              type="submit"
